...
| 52 | LAB-4-AXI-SCOREBOARD-LAB | P1 | todo | CONTENT-AXI-6-VERIFICATION | Create the hands-on AXI lab where learners reconstruct channel traffic into transactions and verify outstanding reads/writes with a scoreboard. |
