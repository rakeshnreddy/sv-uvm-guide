...
| `W5-ISV4-SPLIT` | `complete` | Split `I-SV-4` (Assertions) into A & B | Create `I-SV-4A_SVA_Fundamentals` and `I-SV-4B_Advanced_Temporal_Logic`. Build `TemporalLogicExplorer.tsx` for 4B. Build "Data Integrity Challenge" lab for 4B. |
