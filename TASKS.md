...
| 53 | LAB-5-AXI-DEADLOCK-HUNT | P1 | todo | CONTENT-AXI-5-PITFALLS-DEADLOCKS | Create the advanced AXI lab where learners analyze a waveform to identify a subtle cyclic/channel-dependency deadlock and write a protocol assertion to catch it. |
| 54 | CONTENT-AMBA-F1-BRIDGES-SYSTEM | P1 | todo | CONTENT-AHB-3-VERIFICATION, CONTENT-AXI-6-VERIFICATION | Author the expert integration module for AHB↔AXI bridges, burst splitting/merging hazards, formal/property strategy, and reset/CDC behavior. |
| 55 | VIZ-18-BRIDGE-TRANSLATION | P1 | todo | CONTENT-AMBA-F1-BRIDGES-SYSTEM | Build the BridgeTranslationExplorer to visualize AHB requests splitting/merging into AXI transactions. |
