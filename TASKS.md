...
| 47 | CONTENT-AXI-4-EXPERT-FEATURES | P1 | todo | CONTENT-AXI-3-ORDERING-IDS | Author the AXI Expert Features module covering AxCACHE, AxPROT, AxQOS, and Exclusive Accesses (LDREX/STREX). |
| 48 | VIZ-16-EXCLUSIVE-ACCESS | P1 | todo | CONTENT-AXI-4-EXPERT-FEATURES | Build the ExclusiveAccessVisualizer to show success/failure of LDREX/STREX atomic operations across an interconnect. |
| 49 | CONTENT-AXI-5-PITFALLS-DEADLOCKS | P0 | todo | CONTENT-AXI-4-EXPERT-FEATURES | Author the AXI Pitfalls & Deadlocks module covering channel dependency deadlocks, cyclic interconnect deadlocks, cross-page boundary violations, and misaligned strobes. |
| 50 | VIZ-17-AXI-DEADLOCK-SIMULATOR | P0 | todo | CONTENT-AXI-5-PITFALLS-DEADLOCKS | Build the AxiDeadlockSimulator visual graph of channel dependencies showing how improper stalling causes interconnect deadlock. |
| 51 | CONTENT-AXI-6-VERIFICATION | P0 | todo | CONTENT-AXI-5-PITFALLS-DEADLOCKS | Author the AXI verification module covering monitor reconstruction, scoreboards for in-order and per-ID flows, protocol assertions, and latency measurement. |
