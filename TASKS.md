...
| 34 | CONTENT-PROT-2-INTUITION | P0 | complete | CONTENT-PROT-1-AMBA-FOUNDATIONS | Author the Protocol Intuition & Memory Hooks module, using analogies (highways, mail rooms) to build a permanent mental model of channel directions, handshakes, and decoupling. |
| 35 | VIZ-11-PROTOCOL-ANALOGY | P0 | complete | CONTENT-PROT-2-INTUITION | Build the interactive ProtocolAnalogyExplorer to visualize AXI channels as a mail delivery system. |
| 36 | CONTENT-AHB-1-DESIGN-TIMING | P0 | complete | INFRA-7-PROTOCOL-WAVEFORM-FOUNDATION | Author the AHB/AHB-Lite protocol design and timing module with address/data pipelining, wait states, responses, and burst types. |
| 37 | VIZ-12-AHB-PIPELINE-BURST | P0 | complete | CONTENT-AHB-1-DESIGN-TIMING | Build the interactive AHB timing suite showing single transfers, pipelined phases, wait-state stretching, and burst progression. |
| 38 | CONTENT-AHB-2-PITFALLS | P0 | complete | CONTENT-AHB-1-DESIGN-TIMING | Author the AHB Pitfalls & Real-World Failures module, covering HREADY handling errors, slave ERROR responses, arbitration deadlocks, and boundary cross failures. |
| 39 | CONTENT-AHB-3-VERIFICATION | P0 | complete | CONTENT-AHB-2-PITFALLS, VIZ-12-AHB-PIPELINE-BURST | Author the AHB verification module covering transaction modeling, VIP architecture, assertions, coverage, debug patterns, and interview questions. |
| 40 | LAB-3-AHB-CHECKER-LAB | P1 | complete | CONTENT-AHB-3-VERIFICATION | Create the hands-on AHB lab where learners build an AHB-Lite monitor/checker, add assertions, and triage failing waveforms for HREADY violations. |
| 41 | CONTENT-AXI-1-CHANNEL-ARCHITECTURE | P0 | complete | INFRA-7-PROTOCOL-WAVEFORM-FOUNDATION | Author the AXI fundamentals module covering the five channels, VALID/READY contract, end-to-end write/read flows, and combinatorial loop prevention. |
| 42 | VIZ-13-AXI-CHANNEL-HANDSHAKE | P0 | complete | CONTENT-AXI-1-CHANNEL-ARCHITECTURE | Build the AxiChannelHandshakeVisualizer showing independent channel handshakes and backpressure placement. |
| 43 | CONTENT-AXI-2-BURSTS-MATH | P0 | complete | CONTENT-AXI-1-CHANNEL-ARCHITECTURE | Author the AXI module covering burst math (LEN/SIZE/BURST), address wrap behavior, WSTRB generation, and the 4 KB boundary rule. |
| 44 | VIZ-14-AXI-MEMORY-MATH | P0 | complete | CONTENT-AXI-2-BURSTS-MATH | Build the AxiMemoryMathVisualizer drag-and-drop tool to visualize 4KB boundaries, unaligned starts, and WSTRB bitmask generation. |
| 45 | CONTENT-AXI-3-ORDERING-IDS | P0 | complete | CONTENT-AXI-2-BURSTS-MATH | Author the AXI Ordering and IDs module, detailing outstanding transactions, ID-based routing, out-of-order completion, and interconnect reordering limits. |
| 46 | VIZ-15-AXI-ID-ORDERING | P0 | complete | CONTENT-AXI-3-ORDERING-IDS | Build the AxiIdOrderingVisualizer to show outstanding reads/writes, same-ID ordering, and interconnect reordering. |
| 47 | CONTENT-AXI-4-EXPERT-FEATURES | P1 | complete | CONTENT-AXI-3-ORDERING-IDS | Author the AXI Expert Features module covering AxCACHE, AxPROT, AxQOS, and Exclusive Accesses (LDREX/STREX). |
| 48 | VIZ-16-EXCLUSIVE-ACCESS | P1 | complete | CONTENT-AXI-4-EXPERT-FEATURES | Build the ExclusiveAccessVisualizer to show success/failure of LDREX/STREX atomic operations across an interconnect. |
| 49 | CONTENT-AXI-5-PITFALLS-DEADLOCKS | P0 | complete | CONTENT-AXI-4-EXPERT-FEATURES | Author the AXI Pitfalls & Deadlocks module covering channel dependency deadlocks, cyclic interconnect deadlocks, cross-page boundary violations, and misaligned strobes. |
| 50 | VIZ-17-AXI-DEADLOCK-SIMULATOR | P0 | complete | CONTENT-AXI-5-PITFALLS-DEADLOCKS | Build the AxiDeadlockSimulator visual graph of channel dependencies showing how improper stalling causes interconnect deadlock. |
| 51 | CONTENT-AXI-6-VERIFICATION | P0 | complete | CONTENT-AXI-5-PITFALLS-DEADLOCKS | Author the AXI verification module covering monitor reconstruction, scoreboards for in-order and per-ID flows, protocol assertions, and latency measurement. |
| 52 | LAB-4-AXI-SCOREBOARD-LAB | P1 | complete | CONTENT-AXI-6-VERIFICATION | Create the hands-on AXI lab where learners reconstruct channel traffic into transactions and verify outstanding reads/writes with a scoreboard. |
...
| 64 | BACK-04-INTERVIEW-BANKS-RUBRICS | P1 | complete | BACK-01-HREADY-HREADYOUT-CORRECTION, BACK-02-AXI-4KB-RULE-CORRECTION, BACK-03-SV-SCHEDULING-REGIONS | Create reusable interview banks for SV, UVM, SVA/Formal, Debug, SoC, and AMBA with rubrics and model answers. |
| 65 | BACK-05-UVM-PHASING-CONCURRENCY | P1 | complete | none | Correct and deepen UVM phasing content around run_phase concurrency with runtime sub-phases and senior trap questions. |
| 66 | BACK-06-AXI-DEADLOCK-LAB | P1 | complete | BACK-02-AXI-4KB-RULE-CORRECTION | Add or formalize an AXI deadlock debug lab with broken RTL, SVA/watchdog checks, solution, and acceptance criteria. |
| 67 | BACK-07-BRIDGE-SPLIT-TRANSACTION-LAB | P1 | complete | BACK-01-HREADY-HREADYOUT-CORRECTION, BACK-02-AXI-4KB-RULE-CORRECTION | Enhance or add bridge split-transaction lab coverage for backpressure, 4KB splitting, data ordering, and acceptance criteria. |
| 68 | BACK-08-MINI-UVM-CAPSTONE | P1 | complete | BACK-04-INTERVIEW-BANKS-RUBRICS | Add a mini UVM environment capstone tying together agent, sequence, driver, monitor, scoreboard, coverage, and factory override concepts. |
| 69 | BACK-09-SOC-VERIFICATION-STRATEGY | P1 | complete | BACK-04-INTERVIEW-BANKS-RUBRICS, BACK-08-MINI-UVM-CAPSTONE | Add staff-level SoC verification strategy curriculum and capstone with coverage, debug, formal/liveness, and signoff rubrics. |
| 70 | BACK-10-ACE-CHI-COHERENCY-DEEPENING | P1 | complete | BACK-04-INTERVIEW-BANKS-RUBRICS | Reframe ACE/CHI as current coherency protocols and deepen coherency curriculum, flashcards, and staff-level interview prompts. |
