...
| 35 | VIZ-11-PROTOCOL-ANALOGY | P0 | todo | CONTENT-PROT-2-INTUITION | Build the interactive ProtocolAnalogyExplorer to visualize AXI channels as a mail delivery system. |
| 36 | CONTENT-AHB-1-DESIGN-TIMING | P0 | todo | INFRA-7-PROTOCOL-WAVEFORM-FOUNDATION | Author the AHB/AHB-Lite protocol design and timing module with address/data pipelining, wait states, responses, and burst types. |
| 37 | VIZ-12-AHB-PIPELINE-BURST | P0 | todo | CONTENT-AHB-1-DESIGN-TIMING | Build the interactive AHB timing suite showing single transfers, pipelined phases, wait-state stretching, and burst progression. |
| 38 | CONTENT-AHB-2-PITFALLS | P0 | todo | CONTENT-AHB-1-DESIGN-TIMING | Author the AHB Pitfalls & Real-World Failures module, covering HREADY handling errors, slave ERROR responses, arbitration deadlocks, and boundary cross failures. |
| 39 | CONTENT-AHB-3-VERIFICATION | P0 | todo | CONTENT-AHB-2-PITFALLS, VIZ-12-AHB-PIPELINE-BURST | Author the AHB verification module covering transaction modeling, VIP architecture, assertions, coverage, debug patterns, and interview questions. |
| 40 | LAB-3-AHB-CHECKER-LAB | P1 | todo | CONTENT-AHB-3-VERIFICATION | Create the hands-on AHB lab where learners build an AHB-Lite monitor/checker, add assertions, and triage failing waveforms for HREADY violations. |
| 41 | CONTENT-AXI-1-CHANNEL-ARCHITECTURE | P0 | todo | INFRA-7-PROTOCOL-WAVEFORM-FOUNDATION | Author the AXI fundamentals module covering the five channels, VALID/READY contract, end-to-end write/read flows, and combinatorial loop prevention. |
| 42 | VIZ-13-AXI-CHANNEL-HANDSHAKE | P0 | todo | CONTENT-AXI-1-CHANNEL-ARCHITECTURE | Build the AxiChannelHandshakeVisualizer showing independent channel handshakes and backpressure placement. |
| 43 | CONTENT-AXI-2-BURSTS-MATH | P0 | todo | CONTENT-AXI-1-CHANNEL-ARCHITECTURE | Author the AXI module covering burst math (LEN/SIZE/BURST), address wrap behavior, WSTRB generation, and the 4 KB boundary rule. |
| 44 | VIZ-14-AXI-MEMORY-MATH | P0 | todo | CONTENT-AXI-2-BURSTS-MATH | Build the AxiMemoryMathVisualizer drag-and-drop tool to visualize 4KB boundaries, unaligned starts, and WSTRB bitmask generation. |
| 45 | CONTENT-AXI-3-ORDERING-IDS | P0 | todo | CONTENT-AXI-2-BURSTS-MATH | Author the AXI Ordering and IDs module, detailing outstanding transactions, ID-based routing, out-of-order completion, and interconnect reordering limits. |
| 46 | VIZ-15-AXI-ID-ORDERING | P0 | todo | CONTENT-AXI-3-ORDERING-IDS | Build the AxiIdOrderingVisualizer to show outstanding reads/writes, same-ID ordering, and interconnect reordering. |
