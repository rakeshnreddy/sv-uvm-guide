...
| T3 | ~~A-UVM-3: Advanced Techniques~~ → A-UVM-5: UVM Callbacks | `content/curriculum/T3_Advanced/A-UVM-5_UVM_Callbacks/index.mdx` | ✅ | Deprecated 2026-03; content redistributed to A-UVM-4A/4B (RAL) and A-UVM-5 (Callbacks). Redirect in `next.config.mjs`. |
