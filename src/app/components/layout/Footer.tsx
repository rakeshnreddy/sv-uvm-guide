...
const Footer = () => {
  ...
  return (
    <footer className="bg-background border-t border-gray-700/50 py-8">
      <div className="container mx-auto px-4 text-center text-brand-text-primary/70">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div>
            <h3 className="text-lg font-semibold text-brand-text-primary mb-2">Navigation</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-brand-text-primary mb-2">Company</h3>
            <ul className="space-y-1">
          ...
          <div>
            <h3 className="text-lg font-semibold text-brand-text-primary mb-2">Legal</h3>
            <ul className="space-y-1">
