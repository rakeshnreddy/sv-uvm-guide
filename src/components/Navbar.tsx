...
const navLinks = [
  {
    ...
    href: "/curriculum",
    dropdown: [
      { href: "/curriculum/T1_Foundational", label: "Tier 1: Foundational" },
      { href: "/curriculum/T2_Intermediate", label: "Tier 2: Intermediate" },
      { href: "/curriculum/T3_Advanced", label: "Tier 3: Advanced" },
      { href: "/curriculum/T4_Expert", label: "Tier 4: Expert" },
