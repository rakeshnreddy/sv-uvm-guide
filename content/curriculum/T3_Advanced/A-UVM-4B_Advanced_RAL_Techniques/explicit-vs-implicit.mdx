...
>
  ...
  **Hooking it up**
  ...
  - Lines 14-17 wire the monitor’s [analysis port](/curriculum/T2_Intermediate/I-UVM-2B_TLM_Connections) into the predictor so frontdoor traffic updates the mirror automatically.
