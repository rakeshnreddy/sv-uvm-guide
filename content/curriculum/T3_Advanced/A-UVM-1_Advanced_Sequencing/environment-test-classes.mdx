    ...
    questions={[
      {
        ...
        explanation:
          "`connect_phase` is the right spot to wire components after they exist but before stimulus starts.",
      },
      {
        ...
        explanation:
          "Tests own configuration—override or randomize the config object before the environment reads it.",
      },
    ]}
  />
