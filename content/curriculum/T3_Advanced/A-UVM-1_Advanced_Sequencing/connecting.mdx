    ...
    questions={[
      {
        ...
        explanation:
          "The response channel carries items back to sequences waiting in `get_response()`.",
      },
      {
        ...
        explanation:
          "Passive agents omit the driver/sequencer but remain the source of observation data.",
      },
    ]}
  />
