...
>
  ...
  *IEEE 1800-2023, Clauses 16.3 and 16.4: Immediate and Concurrent assertions*
  ...
  Immediate assertions live in [procedural blocks](/curriculum/T1_Foundational/F2C_Procedural_Code_and_Flow_Control). Concurrent assertions sit outside and observe signal sequences, enabling checks like "req must be followed by ack within 3 cycles." See [multi-clocking](../I-SV-4B_Advanced_Temporal_Logic/multi-clocking) for multi-clock properties.
