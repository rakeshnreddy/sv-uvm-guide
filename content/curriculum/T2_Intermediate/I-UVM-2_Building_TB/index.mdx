...
<div className="my-6 rounded-3xl border border-white/10 bg-white/5 p-6 text-sm text-[rgba(230,241,255,0.8)] backdrop-blur">
  ...
  <p className="mt-3 text-center text-xs uppercase tracking-[0.25em] text-[rgba(230,241,255,0.6)]">
    Hover components to trace stimulus, monitoring, and scoreboard flow.
  </p>
</div>
