...
>
  ...
  Immediate assertions live in <Link href="/curriculum/T1_Foundational/F3A_Procedural_Blocks_and_Flow_Control/flow-control">procedural blocks</Link>. Concurrent assertions sit outside and observe signal sequences, enabling checks like "req must be followed by ack within 3 cycles." See <Link href="/curriculum/T2_Intermediate/I-SV-4_Assertions_SVA/multi-clocking">multi-clocking</Link> for multi-clock properties.
