...
>
  ...
  **Tip:** Give each layer a naming convention (`*_atomic_seq`, `*_scenario_seq`, `*_vseq`) so it is obvious which level to modify.
  ...
  - **Configuration:** Pass knobs through sequence constructors or a dedicated configuration object instead of hard-coded globals. Scenario sequences can aggregate knobs and relay them to atomics.
