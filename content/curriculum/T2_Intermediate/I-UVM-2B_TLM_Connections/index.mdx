...
<div className="my-6 rounded-2xl border border-muted bg-muted/40 p-6">
  ...
  <ol className="ml-6 mt-2 list-decimal space-y-1 text-sm text-muted-foreground">
    <li>Click the connection button on the Driver side to initiate wiring.</li>
    <li>Wait for the connection to be established.</li>
    <li>Click "Drive Traffic" to observe the `txn packet` flow across the bound TLM connection.</li>
    <li>Try disconnecting and driving traffic to observe what happens when a null port is accessed.</li>
  </ol>
