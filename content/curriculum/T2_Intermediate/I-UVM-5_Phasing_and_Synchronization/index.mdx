...
<div className="my-6 rounded-2xl border border-muted bg-muted/40 p-6">
  <h3 className="text-lg font-semibold">Hierarchy Refresher</h3>
  <p className="mt-2 text-sm text-muted-foreground">
    Need the interactive sunburst? Visit <code>Practice → Visualizations → UVM Component Relationships</code>
    to explore how build/connect phases walk the component tree while sequences and transactions stay
    phase-free.
  </p>
</div>
