...
<div className="my-6 rounded-2xl border border-muted bg-muted/40 p-6">
  <h3 className="text-lg font-semibold">Hierarchy Snapshot</h3>
  <p className="mt-2 text-sm text-muted-foreground">
    The full interactive sunburst is available under
    <code>Practice → Visualizations → UVM Component Relationships</code>. Use that tool to toggle
    environments, agents, and leaf components while you map the factory flow described here.
  </p>
</div>
