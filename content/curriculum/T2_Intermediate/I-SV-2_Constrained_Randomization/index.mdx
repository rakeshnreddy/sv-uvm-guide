...
<div className="glass-card glow-border my-8 px-6 py-8">
  <img src="/visuals/randomization-blueprint.svg" alt="Diagram showing constraints feeding the random solver and producing legal transactions" className="w-full" />
</div>
