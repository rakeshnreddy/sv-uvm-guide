...
>
  ...
  **The Analogy:** A covergroup is like a camera. Sampling options decide when the shutter clicks and how the photos are cataloged.
  ...
  -   Call `cg.sample()` manually when your monitor observes a transaction. See the [analysis components](/curriculum/T2_Intermediate/I-UVM-2B_TLM_Connections#monitors-scoreboards-and-the-analysis-fabric) section for how monitors publish transactions through analysis ports.
  ...
  **Coverage Closure Loop:** Feed uncovered bins back into constraint randomization (see [Constrained Randomization](/curriculum/T2_Intermediate/I-SV-2A_Constrained_Randomization_Fundamentals)) or targeted sequences until `option.goal` is satisfied.
