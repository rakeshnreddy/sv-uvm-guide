...
- **Memory hook:** remember *Instantiate → Drive → Check*—now you’ll wrap each step in classes instead of raw tasks. If these ideas feel rusty, revisit the Tier-1 spotlight embedded in `F2A_Core_Data_Types` before continuing.
