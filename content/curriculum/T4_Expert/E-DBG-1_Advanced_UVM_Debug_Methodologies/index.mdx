...
<figure className="my-8 flex flex-col items-center space-y-4">
  <img
    src="/visuals/tier-4/instrumentation-stack-blueprint.svg"
    alt="Stacked cards representing logs, transactions, waveforms, and analytics layers"
    className="w-full max-w-sm rounded-2xl border border-white/10 bg-white/5 p-4"
  />
  <figcaption className="text-sm text-muted-foreground">
    Treat debug as a layered stack—logs, transactions, waveforms, and analytics build on each other to localize failures quickly.
  </figcaption>
</figure>
...
<figure className="my-8 flex flex-col items-center space-y-4">
  <img
    src="/visuals/tier-4/objection-cascade-timeline.svg"
    alt="Swimlane timeline highlighting an objection stall across env, agent, driver, and monitor"
    className="w-full max-w-4xl rounded-2xl border border-white/10 bg-white/5 p-4"
  />
  <figcaption className="text-sm text-muted-foreground">
    Objection cascades reveal exactly where a phase stays raised—here the monitor stalls, helping you target the fix without guesswork.
  </figcaption>
</figure>
...
<figure className="my-8 flex flex-col items-center space-y-4">
  <img
    src="/visuals/tier-4/debug-control-room-mock.svg"
    alt="Air-traffic-control themed debug control room visualization"
    className="w-full max-w-5xl rounded-2xl border border-white/10 bg-white/5 p-4"
  />
  <figcaption className="text-sm text-muted-foreground">
    Present logs, transaction timelines, and waveform probes together so engineers triage failures from a single “control room” dashboard.
  </figcaption>
</figure>
