...
<Card className="mt-8 border-slate-700 bg-slate-900">
  ...
  <CardContent className="space-y-4">
    ...
    <details className="group rounded-lg bg-slate-800 p-4 open:bg-slate-800/80">
      ...
      <div className="mt-4 text-sm text-slate-300 leading-relaxed">
        <p>Non-blocking assignments schedule the update for the NBA region, ensuring that all `always_ff` blocks sample the "old" value of their inputs before any outputs change. This mimics the behavior of physical flip-flops and prevents hold-time races in simulation.</p>
      </div>
    </details>
  </CardContent>
</Card>
