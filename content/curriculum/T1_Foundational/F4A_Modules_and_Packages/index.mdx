...
## Push Further
- Explore **compilation unit scope** (`$unit`) and why it is highly discouraged compared to explicit packages.
- Try creating a package that contains purely virtual classes (an interface package) for UVM use.
