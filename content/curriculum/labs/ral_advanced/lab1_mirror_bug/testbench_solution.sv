// ============================================================
// RAL Mirror Bug Lab — SOLUTION Testbench
// ============================================================
// Fix: The bus monitor's analysis port is now connected to
//      predictor.bus_in in connect_phase, so the RAL mirror
//      updates correctly after every frontdoor transaction.
// ============================================================
...
class codec_env extends uvm_env;
  ...
  function void connect_phase(uvm_phase phase);
    ...
    // FIX: Connect the bus monitor's analysis port to the predictor.
    // This is the critical link that feeds observed bus transactions
    // into the predictor so it can update the RAL mirror.
